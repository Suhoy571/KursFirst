...
namespace KursFirst
{
    public partial class Facultet : Form
    {
        ...
        private bool Button_Press_Enter()
        {
            ...
            {
                MessageBox.Show("Вы не ввели название факультета.", "Ошибка.");
                return false;
            }
            if (string.IsNullOrEmpty(textBox3.Text))
            {
                MessageBox.Show("Вы не ввели краткое название факультета.", "Ошибка.");
                return false;
            }
            return true;
        }
        ...
        private bool Button_Press_Delete()
        {
            ...
            {
                MessageBox.Show("Вы не ввели код факультета для удаления.", "Ошибка.");
                return false;
            }
            return true;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Button_Press_Enter() == true)
            {
                try
                {
                    ...
                    myCommand.CommandText = "INSERT INTO " + "Facultet (Kod, Name, ShortName)" +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (Button_Press_Delete() == true)
            {
                try
                {
                    ...
                    SqlCommand myCommand = conn.CreateCommand();
                    myCommand.CommandText = "DELETE FROM Facultet WHERE Kod = @Kod";
                    myCommand.Parameters.Add("@Kod", SqlDbType.Int, 4);
                    myCommand.Parameters["@Kod"].Value = Kod;
