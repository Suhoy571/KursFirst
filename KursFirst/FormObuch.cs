...
namespace KursFirst
{
    public partial class FormObuch : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Button_Press_Enter() == true)
            {
                try
                {
                    ...
                    myCommand.CommandText = "INSERT INTO " + "FormObuch (Kod, Name, ShortName)" +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (Button_Press_Delete() == true)
            {
                try
                {
                    ...
                    SqlCommand myCommand = conn.CreateCommand();
                    myCommand.CommandText = "DELETE FROM FormObuch WHERE Kod = @Kod";
                    myCommand.Parameters.Add("@Kod", SqlDbType.Int, 4);
                    myCommand.Parameters["@Kod"].Value = Kod;
